...
const checkAnswer = (e) => {
    ...
    switch(e.target.id) {
        ...
        break;
        case 'b3': document.querySelector('#negativ').classList.remove('hidden'); //Klik til positiv feedback
        break;
        case 'b4': document.querySelector('#positiv').classList.remove('hidden'); //Klik til negativ feedback
        break;
